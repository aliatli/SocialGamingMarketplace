                  ...
                  echo '<div class="norow">';
                    echo '<div class="col-md-12" style="border: 1px solid black">';
                      ...
                      echo '<div class="form-group required">';
                        ...
                        echo '<div class="col-md-12">';
                          echo '<input class="form-control" style="font-size:90%" type="password" value="" id="old_password" maxlength="16" placeholder="Old Password">';
                        echo '</div>';
                      echo '</div>';
                      echo '<div class="form-group required">';
                        echo '<label for="new_password" class="col-md-12 col-form-label" style="font-size:100%">New Password:</label>';
                        echo '<div class="col-md-12">';
                          echo '<input class="form-control" style="font-size:90%" type="password" value="" id="new_password" maxlength="16" placeholder="New Password">';
                        echo '</div>';
                      echo '</div>';
                      echo '<div class="form-group required">';
                        echo '<label for="confirm_password" class="col-md-12 col-form-label" style="font-size:100%">Confirm New Password:</label>';
                        echo '<div class="col-md-12">';
                          echo '<input class="form-control" style="font-size:90%" type="password" value="" id="confirm_password" maxlength="16" placeholder="Confirm New Password">';
                        echo '</div>';
                      echo '</div>';
                      echo '<div class="form-group">';
                        echo '<div class="col-md-6">';
                          echo '<button type="submit" class="btn btn-primary">Save New Password</button>';
                        echo '</div>';
                      echo '</div>';
                    echo '</div>';
                  echo '</div>';
